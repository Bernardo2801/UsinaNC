<nav x-data="{ open: false }" class="bg-blue-950 border-b border-gray-600">
        ...
        <div class="flex items-center justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('solicitations.index')" :active="request()->routeIs('solicitations.index')">
                        {{ __('Solicitações') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('requesters.index')" :active="request()->routeIs('requesters.index')">
                        {{ __('Solicitantes') }}
                    </x-nav-link>
                </div>
            </div>

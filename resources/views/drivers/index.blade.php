                ...
                <tbody>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-4 py-2 text-white text-right">
                            <a href="{{ route('drivers.show') }}"  class="text-gray-200 transition hover:text-blue-600 py-1 px-2 active:text-blue-800">
                                <ion-icon name="eye" style="font-size: 28px;"></ion-icon>
                            </a>
                            <a href="{{ route('drivers.edit') }}"  class="text-gray-200 transition hover:text-blue-600 py-1 px-2 active:text-blue-800">

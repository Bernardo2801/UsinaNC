                ...
                <form method="POST" action="{{ route('solicitations.store') }}" class="form-control w-full px-3 py-1.5">
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-gray-300 uppercase">Selecione o
                            Solicitante</label>
                        <select name="requesters_id" id="requesters_id"
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-gray-300 uppercase">Selecione o
                            Material</label>
                        <select name="materials_id" id="materials_id"
                            class="mt-1 block w-full py-2.3 px-0 text-sm text-blue-600 dark:text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600">
                    ...
                    <div class="form-group mb-6">
                        ...
                        <input type="number" step="0.01"
                            ...
                            placeholder="Informe o preço atual do material de acordo com sua medida..." required>
                    </div>
                    <div class="form-group mb-6" x-data>
                        ...
                        <input type="text" maxlength="22"
                            class="block w-full py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600"
                            placeholder="Digite o Nº do Processo Sei..." name="sei-process" x-mask="99999-99999999/9999-99"
                            required>
                    </div>
                    <div class="form-group mb-6">
                    ...
                    <div class="form-group mb-6">
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <div class="flex items-center me-4">
                                <input id="teal-radio" type="radio" value="iniciado" name="colored-radio"
                            ...
                            <div class="flex items-center me-4">
                                <input id="orange-radio" type="radio" value="processo" name="colored-radio"
                            ...
                            <div class="flex items-center me-4">
                                <input id="green-radio" type="radio" value="finalizado" name="colored-radio"
                            ...
                            <div class="flex items-center me-2">
                                <input id="red-radio" type="radio" value="cancelado" name="colored-radio"
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-gray-300 uppercase">Selecione o
                            Motorista</label>
                        <select name="drivers_id" id="drivers_id"
                            class="mt-1 block w-full py-2.3 px-0 text-sm text-blue-600 dark:text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600">
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-gray-300 uppercase">Selecione o
                            Veiculo</label>
                        <select name="vehicles_id" id="vehicles_id"
                            class="mt-1 block w-full py-2.3 px-0 text-sm text-blue-600 dark:text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600">
                    ...
                    <textarea id="message" nam e="message" rows="4" maxlength="320"

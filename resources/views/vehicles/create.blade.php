                ...
                <form method="POST" action="{{ route('vehicles.store') }}" class="form-control w-full px-3 py-1.5">
                    @csrf
                        ...
                        <div class="form-group mb-6">
                            ...
                            <input type="text" name="vehicle_type" id="vehicle_type" class="block w-full py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600" placeholder="Informe o tipo deste veículo..."
                            required>
                        </div>
                        <div class="form-group mb-6">
                            <label for="title" class="block text-sm font-medium text-gray-300 uppercase">Placa</label>

                            <input type="text" name="plate" id="plate" maxlength="7" class="block w-full py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600" placeholder="Informe a placa..."
                            required>
                        ...
                        <div class="form-group mb-6">
                            ...
                            <input type="text" name="chassi" id="chassi" maxlength="17" class="block w-full py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:border-blue-500 focus:outline-none focus:ring-0 focus-text-white focus-border-blue-600" placeholder="Informe o chassi..."
                            required>
                        </div>

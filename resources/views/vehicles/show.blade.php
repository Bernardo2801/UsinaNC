                    ...
                    <div class="w-full h-max rounded-xl">
                        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            ...
                            <div class="flex flex-col py-3">
                                ...
                                <dd class="text-lg font-semibold">{{ date('d/m/Y - H:i:s', strtotime($vehicle->created_at)) }}</dd>
                            </div>
                            <div class="flex flex-col py-3">
                                <dt class="mb-1 text-gray-500 md:text-lg dark:text-gray-400 uppercase">Ultima edição:</dt>
                                <dd class="text-lg font-semibold">{{ date('d/m/Y - H:i:s', strtotime($vehicle->updated_at)) }}</dd>
                            </div>
                        ...
                        <dl class="max-w-md text-gray-900 divide-y divide-gray-200 dark:text-white dark:divide-gray-700">
                            <div class="flex flex-col pb-3">
                                ...
                                <dd class="text-lg font-semibold">
                                    <div>
                                        <a href="{{ route('vehicles.edit', $vehicle->id) }}" class="text-gray-200 transition hover:text-blue-600 py-1 mr-2 active:text-blue-800">
                                            <ion-icon name="create" style="font-size: 28px;"></ion-icon>
                                        </a>
                                        <button type="button" onclick="confirmDelete({{ $vehicle->id }})" class="text-red-600 hover:text-red-700 focus:text-red-800 active:text-red-900 focus focus:outline-none transition ease-in-out duration-150

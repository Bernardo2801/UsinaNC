    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-6 lg:p-8">
            <div class="bg-gray-800 border-b border-gray-200">
                ...
                <div class="mb-4">
                    <a href="#" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 transition ease-in-out duration-150">Adicionar Solicitações</a>
                </div>

                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            <th class="px-4 py-2 font-semibold text-white tracking-widest text-center">Nº Processo SEI</th>
                            <th class="px-4 py-2 font-semibold text-white tracking-widest text-center">Nome Orgão</th>
                            <th class="px-4 py-2 font-semibold text-white tracking-widest text-center">Material solicitado</th>
                            <th class="px-4 py-2 font-semibold text-white tracking-widest text-center">Quantidade solicitada</th>

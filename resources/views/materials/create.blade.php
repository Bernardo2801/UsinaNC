    ...
    <div class="py-12">
        <div class="px-4 sm:w-2/3 lg:w-1/2 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="rounded-lg shadow-lg bg-slate-50 dark:bg-slate-800 py-10 md:py-12 px-4 md:px-6">
                ...
                <form method="POST" action="{{ route('materials.store') }}" class="form-control w-full px-3 py-1.5">
                    @csrf
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-slate-800 dark:text-gray-300 uppercase">Preço por
                            medida</label>
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-slate-800 dark:text-gray-300 uppercase">Quantidade
                            disponível</label>
                    ...
                    <label for="message" class="block mb-2 text-sm font-medium text-slate-800 dark:text-gray-300 uppercase">Observação</label>

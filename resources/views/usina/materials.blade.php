...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-4 tracking-widest mb-8">
                <div>
                    <a href="/adicionar/material" class="inline-flex items-center p-4 bg-gray-600 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 transition ease-in-out duration-150 h-16"><ion-icon name="add-outline" class="text-[26px] mr-2"></ion-icon>Adicionar material</a>
                </div>
                ...
                <form class="max-w-md w-96">
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 h-16" placeholder="Pesquise material, preço..." required />
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            ...
                            <th class="px-4 py-2 font-semibold text-white tracking-widest text-center uppercase">Quantidade disponível</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2 text-white text-center">2</td>
                            <td class="border px-4 py-2 text-white text-center">Toneladas</td>

                            <td class="border px-4 py-2 text-center">
                                <div class="flex justify-center">

                                    <a href="/visualizar/material" class="text-gray-200 transition hover:text-blue-600 py-1 px-2 active:text-blue-800">
                                        <ion-icon name="eye" style="font-size: 28px;"></ion-icon>
                                    </a>
                                    <a href="/editar/material" class="text-gray-200 transition hover:text-blue-600 py-1 px-2 active:text-blue-800">

...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-4 tracking-widest mb-8">
                <div>
                    <a href="/adicionar/solicitacao" class="inline-flex items-center p-4 bg-gray-600 border border-transparent rounded-md font-semibold text-sm text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 transition ease-in-out duration-150 h-16"><ion-icon name="add-outline" class="text-[26px] mr-2"></ion-icon>Adicionar solicitações</a>
                </div>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2 text-center">
                                <div class="flex justify-center">
                                    ...
                                    <a href="/visualizar/solicitacao" class="text-gray-200 transition hover:text-blue-600 py-1 px-2 active:text-blue-800">
                                        <ion-icon name="eye" style="font-size: 28px;"></ion-icon>
                                    </a>
                                    <a href="/editar/solicitacao" class="text-gray-200 transition hover:text-blue-600 py-1 px-2 active:text-blue-800">

            ...
            <div class="rounded-lg shadow-lg bg-slate-50 dark:bg-slate-800 py-10 md:py-12 px-4 md:px-6">
                ...
                <div class="mb-2">
                    <h3 class="px-3 py-1.5 font-semibold text-sm text-slate-800 dark:text-white uppercase tracking-widest">Preencha os campos
                        para adiconar novo solicitante.</h3>
                </div>
                <form method="POST" action="{{ route('requesters.store') }}" class="form-control w-full px-3 py-1.5">
                    @csrf
                    <div class="form-group mb-6">
                        <h3 class="block text-sm font-medium text-slate-800 dark:text-gray-300 uppercase">Tipo</h3>
                        <ul class="grid w-full gap-2 md:grid-cols-2">
                            <li>
                                ...
                                <label for="type_requester"
                                    ...
                                    <div class="block h-28">
                                        <div class="w-full text-lg font-semibold text-slate-800 dark:text-gray-300">Orgão Público</div>
                            ...
                            <li>
                                <input type="radio" id="type_requester_i" name="type_requester" value="Departamento Interno"
                                    class="hidden peer">

                                <label for="type_requester_i"
                                    class="inline-flex items-center justify-between w-full p-3 text-gray-500 bg-white border border-gray-200 rounded-lg cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-blue-600 peer-checked:text-blue-600 hover:text-gray-600 hover:bg-gray-100 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                                    <div class="block h-28">
                                        <div class="w-full text-lg font-semibold text-slate-800 dark:text-gray-300">Departamento Interno</div>
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-slate-800 dark:text-gray-300 uppercase">Nome do Orgão</label>
                    ...
                    <div class="form-group mb-6">
                        <label for="title" class="block text-sm font-medium text-slate-800 dark:text-gray-300 uppercase">Chefe de departamento</label>
                    ...
                    <textarea id="observation" name="observation" rows="4"
                        ...
                        placeholder="Caso exista alguma observação sobre este solicitante, escreva aqui..."></textarea>
                    ...
                    <button type="submit"
                        ...
                        value="Adicionar novo solicitante">
